...
if( !class_exists( 'Redux_import_export' ) ) {
	...
	class Redux_import_export {
		...
		public function render() {
			...
			echo '<p><input type="file" id="reduxbackupjson" name="reduxbackupjson" accept=".json" hidden /><a href="javascript:void(0);" id="redux-import-file-button" class="button-secondary">' . __( 'Import from File', 'redux-framework' ) . '</a> <a href="javascript:void(0);" id="redux-import-code-button" class="button-secondary">' . __( 'Import from Clipboard', 'redux-framework' ) . '</a> <a href="javascript:void(0);" id="redux-import-link-button" class="button-secondary">' . __( 'Import from URL', 'redux-framework' ) . '</a></p>';
			...
			global $wpdb;
			$cws_options = (array) $wpdb->get_results("SELECT o.option_name, o.option_value FROM $wpdb->options AS o WHERE o.option_name LIKE 'cws-" . THEME_SLUG . "-%'");
			$backup_options['cws-' . THEME_SLUG] = $cws_options;
		...
		public function render_tab(){
			...
			echo '<a href="javascript:void(0);" id="import_export_default_section_group_li_a" class="redux-group-tab-link-a" data-rel="import_export_default">' . $icon . ' <span class="group_title">' . __( 'Importa / Exporta', 'redux-framework' ) . '</span></a>';
			echo '</li>';
